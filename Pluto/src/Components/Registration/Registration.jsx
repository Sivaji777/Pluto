                    ...
                    <div class="loginSec1_cont">
                        <aside class="nnr loginBox wow fadeInRight">
                            <div class="signIn transition3">
                                 <h5 className='wlcm'>START YOUR JOURNEY</h5>
                                <h3>Sign Up</h3>
                                <p className='fid'>Fill in the data for profile. It will take a couple of minutes. We only need a few details.</p>

                                <div className="tacbox">
                                <input className='ckbx' id="checkbox" type="checkbox" />
                                <label for="checkbox"> I agree to these <a className='tnc' href="#">Terms of use</a>.</label>
                                </div>
                                
                                <ul class="signinForm2">
                                    <li class="styled-input unIcon">
                                        <h4 className='eml'>Full Name</h4>
                                ...
                                {visible && <label class="submitBtn"><span>Sign up</span><input type="button" class="submit_btn" onClick={() => handleSubmit()} /></label>}
                            </div>
